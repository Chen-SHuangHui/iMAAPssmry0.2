...
#'Summary the output of iMAAPs
#'
#'This function accepts the output files (.rawld and .ad)
#'of iMAAPs and summarizes the data.
#' Required arguments:
# ------------------
...
#'
#' @param output files of iMAAPs, the number of chromosomes, denoise cutoff, method
#' @return Summary of iMAAPs output
#' @export
iMAAPssmry<-function(ad_inp, rawld_inp, num_chr, denoise_cut, method="median"){
